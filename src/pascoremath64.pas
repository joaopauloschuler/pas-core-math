...
const
  cRsqrtNegNanThresh: Tb64u64 = (u: QWord($FFF0000000000000));
...
const
  ...
  cAtanALo: array[0..128] of Tb64u64 = (
    ...
    (u:$3C436E7F8A3F5E42),(u:QWord($BBFAC986EFB92662)),(u:$3C406EC8011EE816),
    (u:QWord($BC5858437D431332)),(u:QWord($BC3CEBD13EB7C513)),(u:QWord($BC5840CAC0D81DB5)),
    (u:$3C5400B0FDAA109E),(u:$3C40E04E06C86E72),(u:$3C4F7AD829163CA7),
    (u:QWord($BC52680735CE2CD8)),(u:QWord($BC690559690B42E4)),(u:$3C591D29110B41AA),
    (u:QWord($BC4EA90E27182780)),(u:QWord($BC2DC82AC14E3E1C)),(u:QWord($BC573A10FD13DAAF)),
    (u:QWord($BC63A7FFBEABDA0B)),(u:QWord($BC6DB6627A24D523)),(u:QWord($BC645F97DD3099F6)),
    (u:QWord($BC66293F68741816)),(u:QWord($BC6AB240D40633E9)),(u:QWord($BC2DE34D14E832E0)),
    (u:$3C6AF540D9FB4926),(u:$3C6DA60FDBC82AC4),(u:QWord($BC792A601170138A)),
    (u:QWord($BC67F1FCA1D5D15B)),(u:QWord($BC64E223EA716C7B)),(u:$3C7B24C824AC51FC),
    (u:$3C64314CD132BA43),(u:QWord($BC711F1E0817879A)),(u:QWord($BC6C3DEA4DBAD538)),
    (u:$3C660D1B780EE3EB),(u:QWord($BC4AB5EDB7DFA545)),(u:QWord($BC68E1437048B5BD)),
    (u:QWord($BC706951C97B050F)),(u:QWord($BC414AF9522AB518)),(u:QWord($BC7ABA0D7D97D1F2)),
    (u:$3C4095BC4EBC2C42),(u:$3C8798826FA27774),(u:$3C8008F6258FC98F),
    (u:QWord($BC5462AF7CEB7DE6)),(u:QWord($BC71184DFD78B472)),(u:$3C79141876DC40C5),
    (u:$3C8481C20189726C),(u:$3C82E851BD025441),(u:$3C713ADA9B8BC419),
    (u:QWord($BC805B4C3C4CBEE8)),(u:QWord($BC85619249BD96F1)),(u:QWord($BC6B0A0FBCAFC671)),
    (u:QWord($BC819FF2DC66DA45)),(u:$3C81320449592D92),(u:QWord($BC81FDDCD2F3DA8E)),
    (u:$3C6D44A42E35CC97),(u:QWord($BC7585A178B4A18D)),(u:$3C6F95A531B3A970),
    (u:QWord($BC396C2D43CA3392)),(u:QWord($BC6A5BED94B05DEF)),(u:$3C454509D2BFF511),
    (u:QWord($BC6B4C867CEF300C)),(u:QWord($BC1DDFAC663D6BC6)),(u:QWord($BC7A510683FF7CB6)),
    (u:$3C44FDCD8E4E8710),(u:$0000000000000000),(u:QWord($BC8DEEC7FC9042AD)),
    (u:QWord($BC8395AE45E0657D)),(u:$3C8332CF301A97F3),(u:QWord($BC86CC8C4B78213B)),
    (u:$3C870A90841DA57A),(u:QWord($BC6BA39BAD450EE0)),(u:QWord($BC88692946D9F93C)),
    (u:$3C63B711BF765B58),(u:$3C7C21387985B081),(u:QWord($BC87DDB19D3D0EFC)),
    (u:QWord($BC7F5E354CF971F3)),(u:QWord($BC700F0AD675330D)),(u:QWord($BC82C93F50AB2C0E)),
    (u:$3C7BEC391ADC37D5),(u:QWord($BC69686DDC9FFCF5)),(u:QWord($BC78D16529514246)),
    (u:QWord($BC8092F51E9C2803)),(u:QWord($BC807C06755404C4)),(u:$3C802E0D43ABC92B),
    (u:$3C5D0184E48AF6F7),(u:$3C773BE957380BC2),(u:QWord($BC702B6E26C84462)),
    (u:$3C525C4F3FFA6E1F),(u:QWord($BC5E302DB3C6823F)),(u:$3C73207830326C0E),
    (u:QWord($BC66308CEE7927BF)),(u:QWord($BC70147EBF0DF4C5)),(u:QWord($BC7168533CC41D8B)),
    (u:QWord($BC652A0B0333E9C5)),(u:$3C68659EECE35395),(u:$3C820FCAD18CB36F),
    (u:QWord($BC752AFDBD5A8C74)),(u:QWord($BC79747A792907D7)),(u:$3C790C59393B52C8),
    (u:$3C7AF6934F13A3A8),(u:QWord($BC48534DCAB5AD3E)),(u:QWord($BC7555AA8BFCA9A1)),
    (u:QWord($BC556B3FEE9CA72B)),(u:$3C54B3FDD4FDC06C),(u:$3C6285D367C55DDC),
    (u:QWord($BC48712976F17A16)),(u:QWord($BC3ABE8AB65D49FC)),(u:$3C5CD9BE81AD764B),
    (u:$3C4742C2922656FA),(u:QWord($BC77C842978BEE09)),(u:$3C67BC7DEA7C3C03),
    (u:$3C4AEFBE25B404E9),(u:QWord($BC34BCFAAA95CB2C)),(u:$3C50FE741E4EC679),
    (u:$3C5FE74A5B0EC709),(u:$3C50CA1C19F710EF),(u:$3C52867B40BA77D6),
    (u:$3C60FD4E0D4B1547),(u:$3C5C16C9ECC1621D),(u:$3C56B81A36E75E8C),
    (u:QWord($BC57C22045771848)),(u:$3C5970503BE105C0),(u:QWord($BC3F299D010AEAD2)),
    (u:$3C5D2B61DEFF33EC),(u:$3BF0E84D9567203A),(u:QWord($BBFAD44B44B92653)),
    (u:QWord($BC3296D577B5E21D)),(u:$3C02DB53886013CA),(u:$0000000000000000));
  ...
  cAtanCh_1: Tb64u64 = (u:QWord($BFD555555555552B));  // -0x1.555555555552bp-2
  cAtanCh_2: Tb64u64 = (u:$3FC9999999069C20);  //  0x1.9999999069c2p-3
  cAtanCh_3: Tb64u64 = (u:QWord($BFC248D2C8444AC6));  // -0x1.248d2c8444ac6p-3

  // Small-x polynomial: ch2[0..3]
  cAtanCh2_0: Tb64u64 = (u:QWord($BFD5555555555555));  // -0x1.5555555555555p-2
  cAtanCh2_1: Tb64u64 = (u:$3FC99999999998C1);  //  0x1.99999999998c1p-3
  cAtanCh2_2: Tb64u64 = (u:QWord($BFC249249176AEC0));  // -0x1.249249176aecp-3
  ...
  cAtanIdLo3:  Tb64u64 = (u:QWord($B97FC8F8CBB5BF80));  // -0x1.fc8f8cbb5bf8p-104
  ...
  cAtanRefCh0H: Tb64u64 = (u:QWord($BFD5555555555555));  // -0x1.5555555555555p-2
  cAtanRefCh0L: Tb64u64 = (u:QWord($BC75555555555555));  // -0x1.5555555555555p-56
  cAtanRefCh1H: Tb64u64 = (u:$3FC999999999999A);  //  0x1.999999999999ap-3
  cAtanRefCh1L: Tb64u64 = (u:QWord($BC6999999999BCB8));  // -0x1.999999999bcb8p-57
  cAtanRefCh2H: Tb64u64 = (u:QWord($BFC2492492492492));  // -0x1.2492492492492p-3
  cAtanRefCh2L: Tb64u64 = (u:QWord($BC6249242093C016));  // -0x1.249242093c016p-57
  cAtanRefCl0:  Tb64u64 = (u:$3FBC71C71C71C71C);  //  0x1.c71c71c71c71cp-4
  cAtanRefCl1:  Tb64u64 = (u:QWord($BFB745D1745D1265));  // -0x1.745d1745d1265p-4
...
const
  ...
  cLog2L1Lo: array[0..32] of Tb64u64 = (
    (u:$0000000000000000),(u:$3E51435EDC775B51),(u:$3E5C8F1CBF9E4073),(u:QWord($BE57BF30FA53957B)),
    (u:$3E4674D30B6276ED),(u:$3E399FCF0D796ACE),(u:QWord($BE55FFD8B92706D2)),(u:$3E5BEF90BC5A116D),
    (u:$3E5FCA73B3D53F0D),(u:QWord($BE441024E560E04E)),(u:$3E5484024FAD8461),(u:$3E52D9AB90BA7694),
    (u:QWord($BE52C998EA30BA7B)),(u:QWord($BE475FC8682F918E)),(u:QWord($BE5F02F268A85FB8)),(u:QWord($BE450030EA7FAE4B)),
    (u:QWord($BE3BFFB8DA5B849D)),(u:$3E3F71993FF95475),(u:$3E288028E67F78FA),(u:$3E5F915F5A0B4E89),
    (u:$3E1C2FE288F968F8),(u:$3E57375A75AE0837),(u:$3E291E48BE920323),(u:$3E2EE7BC0D39A3DB),
    (u:QWord($BE2899E2AC5F778C)),(u:$3E5F1F20176130A7),(u:$3E403FC59D34A4F3),(u:QWord($BDF68722010E4653)),
    (u:QWord($BE558783D505A6EC)),(u:$3E4B212AB9F8D51D),(u:QWord($BE5B3ECD767BE776)),(u:$3E4B1AD41F07FC10),
    (u:$0000000000000000));
  ...
  cLog2L2Lo: array[0..32] of Tb64u64 = (
    (u:$0000000000000000),(u:QWord($BE4E2B19F9C7B840)),(u:QWord($BE4B1D68137631FE)),(u:QWord($BE4AA92227513FC3)),
    (u:QWord($BE452918E3AB6F5E)),(u:$3E41A0B9B9010A9C),(u:$3E509B87F57867EC),(u:QWord($BE33D6B70C673BE6)),
    (u:$3E476D340A6780AB),(u:$3E5E4181E37D9E05),(u:QWord($BE48C181F042B901)),(u:$3E49890AE7761D66),
    (u:QWord($BE555977AE613D5F)),(u:$3E4C75F49ACF5E56),(u:QWord($BE3E1FC84D0D42BC)),(u:QWord($BE55AB8A182ED279)),
    (u:QWord($BE5B389A7D8A21D9)),(u:QWord($BE57376F1A891FA5)),(u:QWord($BE30915581B87A8A)),(u:$3E4B7F2EAA894FCA),
    (u:QWord($BE5F8C41BDD38C23)),(u:$3E304FFB1F3C8215),(u:$3E5A398CCF2B137D),(u:$3E5373B5BCE07F39),
    (u:QWord($BE4E42040FD9D454)),(u:$3E4EA00EB5770526),(u:QWord($BE53E2002BB54BB8)),(u:$3E5797EC835DB8D3),
    (u:$3E3BDCD45FEDD285),(u:QWord($BE333B8F09D1A210)),(u:QWord($BE458937A8EEA36F)),(u:QWord($BE43E76203FF54CD)),
    (u:QWord($BE16560F19FC3F41)));
  ...
  cLog2C0: Tb64u64 = (u:QWord($BFD62E41D56C6400));
  cLog2C1: Tb64u64 = (u:$3FC47FD2632D2D32);
  cLog2C2: Tb64u64 = (u:QWord($BFB5504497831BA7));
  cLog2C3: Tb64u64 = (u:$3FA7A3314C5BEF3C);
  cLog2L2H: Tb64u64 = (u:$3FF7154800000000);
  cLog2L2L: Tb64u64 = (u:QWord($BE9AD47A2F472159));
  ...
  cLog2LL0: array[0..16, 0..2] of Tb64u64 = (
    ...
    ((u:$3FBFFFFFDA070000), (u:QWord($BD0B38AE1C2D5400)), (u:QWord($BA210F11908C5C8D))),
    ((u:$3FC7FFFFEFB50000), (u:$3D4785D91BB08320), (u:$3A2F5DED30CA48C0)),
    ((u:$3FD0000004A60000), (u:$3D5380ABF8FE7EB0), (u:QWord($BA2EBD3F567DF886))),
    ((u:$3FD4000009760000), (u:$3D4D321385BF0A10), (u:QWord($BA1C95A3D59B6C33))),
    ((u:$3FD80000081B4000), (u:$3D5B6E8F25FF2610), (u:QWord($BA24072D39D44270))),
    ((u:$3FDC00000F4F4000), (u:$3D4A5FED334580A0), (u:QWord($B9F6F8FDABADD77A))),
    ((u:$3FDFFFFFF9DE0000), (u:QWord($BD4F85A54FB4A600)), (u:QWord($B9F50083897EE638))),
    ((u:$3FE1FFFFFA35C000), (u:$3D5795DB9D185140), (u:QWord($BA1594F07D4D693F))),
    ((u:$3FE3FFFFF9CBC000), (u:$3D32FB09A99477A0), (u:$3A1B2C6248382152)),
    ((u:$3FE5FFFFF6DF2000), (u:QWord($BD53ECF24077C3A0)), (u:QWord($BA2382C6B4E2DAA6))),
    ((u:$3FE800000552E000), (u:$3D47044806F72380), (u:QWord($BA26DA3EB126C999))),
    ((u:$3FE9FFFFFC182000), (u:$3D45CF031D5D4CF0), (u:$3A2302C44DA79F4B)),
    ((u:$3FEBFFFFF6B62000), (u:$3D548D11D13372A8), (u:$3A2F045032543C0D)),
    ((u:$3FEDFFFFF7A42000), (u:QWord($BD40CBF3E62FA860)), (u:$3A21CFAF84227211)),
    ((u:$3FF0000000000000), (u:$0000000000000000), (u:$0000000000000000)));

  cLog2LL1: array[0..16, 0..2] of Tb64u64 = (
    ((u:$0000000000000000), (u:$0000000000000000), (u:$0000000000000000)),
    ((u:$3F7000024A000000), (u:QWord($BD5799935D030650)), (u:QWord($BA0CACAD0B61C964))),
    ((u:$3F8000014A880000), (u:QWord($BD586DD926D35EE8)), (u:QWord($BA2277AB54C00E64))),
    ((u:$3F87FFFF7B380000), (u:$3D15FFC7FF00E600), (u:$3A25870383C1225D)),
    ((u:$3F9000004B940000), (u:QWord($BD44AA9DA7EA0120)), (u:QWord($BA247DECFE981022))),
    ((u:$3F94000064380000), (u:QWord($BD5015D79FD24C70)), (u:$3A2EC26C231DDB4C)),
    ((u:$3F97FFFF8FF80000), (u:QWord($BD5A62A2B755F048)), (u:QWord($BA2EEBE936E9A3F9))),
    ((u:$3F9C000048180000), (u:$3D1D1A1BBCE5F580), (u:QWord($BA24DD25E141AD16))),
    ((u:$3FA0000050EE0000), (u:QWord($BD5B32450688D5E0)), (u:$3A2577A1C80A65B0)),
    ((u:$3FA2000014760000), (u:QWord($BD3BAC8F6C103D40)), (u:QWord($BA1157A2472C9532))),
    ((u:$3FA3FFFFF2440000), (u:QWord($BD4FBAB0C9D05AA0)), (u:QWord($BA13680FFABF1A5B))),
    ((u:$3FA5FFFFB1CE0000), (u:$3D4EF9EC2BA49140), (u:QWord($BA224850720B73AB))),
    ((u:$3FA7FFFFD9600000), (u:$3D514E3A91ABEFF0), (u:QWord($BA140E3565C114DD))),
    ((u:$3FAA0000321C0000), (u:$3D3E33C6A0732340), (u:QWord($BA27E8C937A981D8))),
    ((u:$3FABFFFFC56A0000), (u:QWord($BD52076781FF0460)), (u:QWord($BA296E054EC8F31E))),
    ((u:$3FADFFFFDBA40000), (u:QWord($BD4EA8B4476EDDE0)), (u:QWord($B9E07BFB9FDE770F))),
    ((u:$3FB000001FDA0000), (u:$3D55ED58A7FF2C40), (u:$39F512ACBB219717)));

  cLog2LL2: array[0..16, 0..2] of Tb64u64 = (
    ((u:$0000000000000000), (u:$0000000000000000), (u:$0000000000000000)),
    ((u:$3F30002866000000), (u:QWord($BD5329E31412B688)), (u:$3A2279DDC3585863)),
    ((u:$3F3FFFED31000000), (u:$3D5546DCB40B0518), (u:QWord($BA26D048F41DEBEC))),
    ((u:$3F48000388000000), (u:$3D5FCE6789678C88), (u:$3A24959DC2FEA030)),
    ((u:$3F50000668400000), (u:$3D5C5CAEC0AA6620), (u:QWord($BA289D58A2E0D287))),
    ((u:$3F54000937000000), (u:QWord($BD5DF91BF5DB20F8)), (u:$3A2D4FC35005498A)),
    ((u:$3F58000A2D800000), (u:$3D3E7464F400A700), (u:QWord($BA26365A147CE4A8))),
    ((u:$3F5C00094A400000), (u:QWord($BD5C55C526E65A68)), (u:QWord($BA2A7EA2CF16D2CE))),
    ((u:$3F60000345400000), (u:$3D48E815121136D0), (u:QWord($BA168F8F7A924FD6))),
    ((u:$3F620000F6400000), (u:$3D57FB19A44DA298), (u:QWord($BA2A05FC6ED4124D))),
    ((u:$3F63FFFDB7000000), (u:$3D5BFAC3B1ABE2E8), (u:QWord($BA09AB1F45A1EFB1))),
    ((u:$3F66000516A00000), (u:QWord($BD402544D9FAF830)), (u:$3A2286C39ADFFA8C)),
    ((u:$3F67FFFFF4200000), (u:QWord($BD52878B893DA790)), (u:$3A2B55C5E09022B1)),
    ((u:$3F6A00056F400000), (u:QWord($BD59D7CCF4019608)), (u:$3A2F4B05553FE340)),
    ((u:$3F6BFFFE65200000), (u:QWord($BD5EE85F47C2B5A0)), (u:$3A253FA913D4E9A6)),
    ((u:$3F6E0001F7600000), (u:$3D42E594FB2AF5E0), (u:QWord($B9CAFAEC77CA8D86))),
    ((u:$3F7000024A000000), (u:QWord($BD5799935D030650)), (u:QWord($BA0CACAD0B61C964))));

  cLog2LL3: array[0..16, 0..2] of Tb64u64 = (
    ((u:$0000000000000000), (u:$0000000000000000), (u:$0000000000000000)),
    ((u:$3EF0014690000000), (u:QWord($BD4743D8EA40A4D0)), (u:QWord($B9E75086A21C12AB))),
    ((u:$3F00014C18000000), (u:$3D48E7FA3CF59080), (u:$3A2A11BDCDB1ACE3)),
    ((u:$3F07FF17C8000000), (u:$3D5118DBBCCE8470), (u:$3A009806ECD19760)),
    ((u:$3F0FFFCBB8000000), (u:QWord($BD5EAA70B2051E38)), (u:$39E0D287C5AA12B4)),
    ((u:$3F14004294000000), (u:$3D5602B04D79B0C8), (u:$39F8D2C8DDF31648)),
    ((u:$3F1800A218000000), (u:QWord($BD50A23112178630)), (u:QWord($BA2C4652435118F1))),
    ((u:$3F1BFF9304000000), (u:QWord($BD4385DC475C16B0)), (u:QWord($B9FE7288F74BBBDA))),
    ((u:$3F1FFFF810000000), (u:$3D4355EDCFF4E190), (u:$3A0F8DAAE6C1DB11)),
    ((u:$3F22002FF2000000), (u:$3D23FBB7CD366140), (u:$3A293C0E5B4DCA92)),
    ((u:$3F23FFAC90000000), (u:QWord($BD39BDE416DE25C0)), (u:QWord($BA2F4DF1D74776B3))),
    ((u:$3F25FFE340000000), (u:QWord($BD521735D0955DC0)), (u:QWord($BA21B0E10765842F))),
    ((u:$3F28001B52000000), (u:$3D40C0949E968810), (u:QWord($BA1D3771C0B220F3))),
  ...
  cLog2Cy1H: Tb64u64 = (u:QWord($BFE71547652B82FE));
  cLog2Cy1L: Tb64u64 = (u:QWord($BC6777D0FFDA0D24));
  cLog2Cy2H: Tb64u64 = (u:$3FDEC709DC3A03FD);
  cLog2Cy2L: Tb64u64 = (u:$3C7D27E96BE541E5);
  cLog2Cl0:  Tb64u64 = (u:QWord($BFD71547652B82FE));
  cLog2Cl1:  Tb64u64 = (u:$3FD2776C50F1FF14);
  cLog2Cl2:  Tb64u64 = (u:QWord($BFCEC709DC3ECA5D));
...
const
  ...
  cAcosCC: array[0..32, 0..7] of Tb64u64 = (
    ...
    ((u:$3FF0055A27E0D033),(u:QWord($BC9D9BA10494C062)),(u:$3FC57C00CB5D6C4D),(u:$3FB37881F5649A75),(u:$3FA759AF49D494DD),(u:$3FA002E1864DDA2E),(u:$3F97C2D5D468CDD9),(u:$3F9292834C025357)),
    ...
    ((u:$3FF0102BCFFD6ACD),(u:QWord($BC8C2294C65D2E86)),(u:$3FC5CAFF17351901),(u:$3FB407ABBC04FEB3),(u:$3FA86179B8005949),(u:$3FA0F97520BD4E72),(u:$3F99950C5C89F3DF),(u:$3F944F2344E7B664)),
    ((u:$3FF015A397CF0F1C),(u:QWord($BC8EEBD6CCFE3EE3)),(u:$3FC5F3581BE7B08B),(u:$3FB4519DDF1AE531),(u:$3FA8EB4B6EE35E92),(u:$3FA17BC85414CD46),(u:$3F9A8E5895E3FCF9),(u:$3F953FAFDC629400)),
    ...
    ((u:$3FF020B1C7DF0575),(u:QWord($BC8DD547E329C1E5)),(u:$3FC645CE0AB901BB),(u:$3FB4EA79C34FC7A6),(u:$3FAA0B8AC08940EC),(u:$3FA28F9BABD0629B),(u:$3F9CA452CF90A55E),(u:$3F97492B016730EF)),
    ((u:$3FF026487C8C5D71),(u:QWord($BC95FD9B68DC3B6E)),(u:$3FC66FF1B67D5D70),(u:$3FB5397D613373EB),(u:$3FAAA24BCE3AEB4A),(u:$3FA3219610B150AC),(u:$3F9DC251825103F1),(u:$3F9863D5A3932532)),
    ...
    ((u:$3FF03195E4C483F1),(u:QWord($BC95DB10AD66EACB)),(u:$3FC6C61C22D908F0),(u:$3FB5DCF46AB9F2CB),(u:$3FABDDF049BB1F4D),(u:$3FA456F7DB6AC768),(u:$3FA013F738BD7BB3),(u:$3F9AC9D739783D21)),
    ((u:$3FF0374CEA0C0C9F),(u:QWord($BC9917BFF5241C76)),(u:$3FC6F22A497B2EC0),(u:$3FB63184D8A79DB5),(u:$3FAC83339CAF946E),(u:$3FA4FAEF331019D4),(u:$3FA0B8917547D678),(u:$3F9C17533F147E1C)),
    ((u:$3FF03D0F082AFCC8),(u:QWord($BC9018BBCDDB49EB)),(u:$3FC71EE385EFDF06),(u:$3FB6880CDA2D3885),(u:$3FAD2DB0CBFAE54D),(u:$3FA5A57C56B50C5E),(u:$3FA16535A40098B2),(u:$3F9D780730B8EBB8)),
    ((u:$3FF042DC6A65FFBF),(u:QWord($BC8C7EA28DCE95D1)),(u:$3FC74C4BD7412F9E),(u:$3FB6E09C6D2B72BC),(u:$3FADDD9DCDA253DE),(u:$3FA656F1F62B5001),(u:$3FA21A5AE2AC77EE),(u:$3F9EED3BCA067F0E)),
    ...
    ((u:$3FF04E99AD5E4BCD),(u:QWord($BC9E97A72FE827E0)),(u:$3FC7A93A5917200C),(u:$3FB7981584731C05),(u:$3FAF4EAC9268FAE2),(u:$3FA7CFF9C3B19721),(u:$3FA3A02D9C1E0145),(u:$3FA10D64A0E56953)),
    ...
    ((u:$3FF05A8621FEB16B),(u:QWord($BC7E5B33B1407C5F)),(u:$3FC809186C2E57DD),(u:$3FB8587D99442DC8),(u:$3FB06C23D1DFCB7F),(u:$3FA969024036DD22),(u:$3FA54E6DD4D2AF33),(u:$3FA2D62F439F2A31)),
    ...
    ((u:$3FF066A34930EC8D),(u:QWord($BC9480F445FEDAD1)),(u:$3FC86C0AFB447A74),(u:$3FB9226E29948D9C),(u:$3FB13E44A9B5A3A6),(u:$3FAB2564FEA8B3FE),(u:$3FA72A2023D92458),(u:$3FA4D8313CEC3485)),
    ((u:$3FF06CC49D38146C),(u:QWord($BC8B55394F4FC07B)),(u:$3FC89EB82831FEED),(u:$3FB98B2D2EB9BB23),(u:$3FB1ACB01E9AB414),(u:$3FAC12012CBD00C6),(u:$3FA82AC7C1D15C38),(u:$3FA5F13925C6EDCA)),
    ((u:$3FF072F2B6F1E601),(u:QWord($BC92DCBB05419970)),(u:$3FC8D2397127AEBB),(u:$3FB9F68DF88DA51D),(u:$3FB21EE26A4F62A1),(u:$3FAD08E707F7AE6F),(u:$3FA93903DEE3FEB0),(u:$3FA71BCFB5C57B59)),
    ((u:$3FF0792DCC0FBD20),(u:QWord($BC75BF23EE4F9D54)),(u:$3FC9069430AB508A),(u:$3FBA64A7ADB4CD85),(u:$3FB29505C8B48349),(u:$3FAE0AA2921CFA60),(u:$3FAA55AEB46F4322),(u:$3FA8593ACAD3BECE)),
    ...
    ((u:$3FF092A054F1A2FC),(u:QWord($BC92F657224E9830)),(u:$3FC9E0EF87243A2C),(u:$3FBC3A3B7366A278),(u:$3FB4989CB22E2175),(u:$3FB1450E5BA7AD39),(u:$3FAF6C02C8F0EF93),(u:$3FAE288FFC8D182C)),
    ((u:$3FF0991FA9BFFBF4),(u:QWord($BC5CA1140A1ABBF4)),(u:$3FCA19E0A8823B80),(u:$3FBCB772900F9C24),(u:$3FB525431F0CBB2E),(u:$3FB1E5C2D06804E1),(u:$3FB06FFEFA7AA6B8),(u:$3FAFDB4704DCA347)),
    ...
    ((u:$3FF0BA78D40A9260),(u:QWord($BC957B07A441E242)),(u:$3FCB46015C126262),(u:$3FBF5E6B94713F3D),(u:$3FB836967D0AFECF),(u:$3FB5823FDD1707B9),(u:$3FB4BED355269DC2),(u:$3FB51E83065121CF)),
    ((u:$3FF0C152382D7366),(u:QWord($BC9EE6913347C2A6)),(u:$3FCB8550D62BFB6E),(u:$3FBFF1BDE0FA3CAD),(u:$3FB8E5F3AB550989),(u:$3FB656BE8B38EBAF),(u:$3FB5C3C13008A099),(u:$3FB662225A1B4F77)));
  ...
  cAcosSLo: array[0..32] of Tb64u64 = (
    (u:$0000000000000000),(u:QWord($BC2912BD0D569A90)),(u:QWord($BC3E2718D26ED688)),(u:$3C513000A89A11E0),
    (u:QWord($BC626D19B9FF8D82)),(u:QWord($BC642DEEF11DA2C4)),(u:QWord($BC75D28DA2C4612D)),(u:QWord($BC1EFDC0D58CF620)),
    (u:QWord($BC672CEDD3D5A610)),(u:$3C65B362CB974183),(u:$3C5E0D891D3C6841),(u:QWord($BC8A5A014347406C)),
    (u:$3C8B25DD267F6600),(u:QWord($BC6EFCC626F74A6F)),(u:$3C68076A2CFDC6B3),(u:QWord($BC875720992BFBB2)),
    (u:QWord($BC8BDD3413B26456)),(u:QWord($BC70F537ACDF0AD7)),(u:QWord($BC82C5E12ED1336D)),(u:QWord($BC830EE286712474)),
    (u:$3C39F630E8B6DAC8),(u:QWord($BC8BC69F324E6D61)),(u:QWord($BC76E0B1757C8D07)),(u:QWord($BC5E7B6BB5AB58AE)),
    (u:$3C7457E610231AC2),(u:QWord($BC8014C76C126527)),(u:$3C8760B1E2E3F81E),(u:$3C752C7ADC6B4989),
  ...
  cAcosPi64L:    Tb64u64 = (u:QWord($B99FC8F8CBB5BF6C));  //  pi/64 lo
...
const
  ...
  cExpT0: array[0..63, 0..1] of Tb64u64 = (
    ...
    ((u:QWord($BC719083535B085E)),(u:$3FF02C9A3E778061)),
    ...
    ((u:QWord($BC96C51039449B3A)),(u:$3FF11301D0125B51)),
    ((u:QWord($BC932FBF9AF1369E)),(u:$3FF1429AAEA92DE0)),
    ((u:QWord($BC819041B9D78A76)),(u:$3FF172B83C7D517B)),
    ...
    ((u:QWord($BC963AEABF42EAE2)),(u:$3FF371A7373AA9CB)),
    ((u:QWord($BC75E436D661F5E2)),(u:$3FF3A7DB34E59FF7)),
    ((u:$3C8ADA0911F09EBC),(u:$3FF3DEA64C123422)),
    ((u:QWord($BC5EF3691C309278)),(u:$3FF4160A21F72E2A)),
    ((u:$3C489B7A04EF80D0),(u:$3FF44E086061892D)),
    ((u:$3C73C1A3B69062F0),(u:$3FF486A2B5C13CD0)),
    ((u:$3C7D4397AFEC42E2),(u:$3FF4BFDAD5362A27)),
    ((u:QWord($BC94B309D25957E4)),(u:$3FF4F9B2769D2CA7)),
    ((u:QWord($BC807ABE1DB13CAC)),(u:$3FF5342B569D4F82)),
    ((u:$3C99BB2C011D93AC),(u:$3FF56F4736B527DA)),
    ((u:$3C96324C054647AC),(u:$3FF5AB07DD485429)),
    ((u:$3C9BA6F93080E65E),(u:$3FF5E76F15AD2148)),
    ((u:QWord($BC9383C17E40B496)),(u:$3FF6247EB03A5585)),
    ((u:QWord($BC9BB60987591C34)),(u:$3FF6623882552225)),
    ((u:QWord($BC9BDD3413B26456)),(u:$3FF6A09E667F3BCD)),
    ((u:QWord($BC6BBE3A683C88AA)),(u:$3FF6DFB23C651A2F)),
    ((u:QWord($BC816E4786887A9A)),(u:$3FF71F75E8EC5F74)),
    ((u:QWord($BC90245957316DD4)),(u:$3FF75FEB564267C9)),
    ((u:QWord($BC841577EE049930)),(u:$3FF7A11473EB0187)),
    ((u:$3C705D02BA15797E),(u:$3FF7E2F336CF4E62)),
    ((u:QWord($BC9D4C1DD41532D8)),(u:$3FF82589994CCE13)),
    ((u:QWord($BC9FC6F89BD4F6BA)),(u:$3FF868D99B4492ED)),
    ((u:$3C96E9F156864B26),(u:$3FF8ACE5422AA0DB)),
    ((u:$3C85CC13A2E3976C),(u:$3FF8F1AE99157736)),
    ((u:QWord($BC675FC781B57EBC)),(u:$3FF93737B0CDC5E5)),
    ((u:QWord($BC9D185B7C1B85D0)),(u:$3FF97D829FDE4E50)),
    ((u:$3C7C7C46B071F2BE),(u:$3FF9C49182A3F090)),
    ((u:QWord($BC9359495D1CD532)),(u:$3FFA0C667B5DE565)),
    ((u:QWord($BC9D2F6EDB8D41E2)),(u:$3FFA5503B23E255D)),
    ((u:$3C90FAC90EF7FD32),(u:$3FFA9E6B5579FDBF)),
    ((u:$3C97A1CD345DCC82),(u:$3FFAE89F995AD3AD)),
    ((u:QWord($BC62805E3084D708)),(u:$3FFB33A2B84F15FB)),
    ((u:QWord($BC75584F7E54AC3A)),(u:$3FFB7F76F2FB5E47)),
    ...
    ((u:QWord($BC9CBC3743797A9C)),(u:$3FFD072D4A07897C)),
    ((u:$3C82ED02D75B3706),(u:$3FFD5818DCFBA487)),
    ((u:$3C9C2300696DB532),(u:$3FFDA9E603DB3285)),
    ((u:QWord($BC91A5CD4F184B5C)),(u:$3FFDFC97337B9B5F)),
    ((u:$3C839E8980A9CC90),(u:$3FFE502EE78B3FF6)),
    ((u:QWord($BC9E9C23179C2894)),(u:$3FFEA4AFA2A490DA)),
  ...
  cExpT1: array[0..63, 0..1] of Tb64u64 = (
    ...
    ((u:QWord($BC57B5D0D58EA8F4)),(u:$3FF00162F3904052)),
    ((u:$3C94115CB6B16A8E),(u:$3FF0021478E11CE6)),
    ((u:QWord($BC8D7C96F201BB2E)),(u:$3FF002C605E2E8CF)),
    ((u:$3C984711D4C35EA0),(u:$3FF003779A95F959)),
    ((u:QWord($BC80484245243778)),(u:$3FF0042936FAA3D8)),
    ((u:QWord($BC94B237DA2025FA)),(u:$3FF004DADB113DA0)),
    ((u:QWord($BC75E00E62D6B30E)),(u:$3FF0058C86DA1C0A)),
    ((u:$3C9A1D6CEDBB9480),(u:$3FF0063E3A559473)),
    ((u:QWord($BC94ACF197A00142)),(u:$3FF006EFF583FC3D)),
    ((u:QWord($BC6EAF2EA42391A6)),(u:$3FF007A1B865A8CA)),
    ((u:$3C7DA93F90835F76),(u:$3FF0085382FAEF83)),
    ((u:QWord($BC86A79084AB093C)),(u:$3FF00905554425D4)),
    ((u:$3C986364F8FBE8F8),(u:$3FF009B72F41A12B)),
    ((u:QWord($BC882E8E14E3110E)),(u:$3FF00A6910F3B6FD)),
    ((u:QWord($BC84F6B2A7609F72)),(u:$3FF00B1AFA5ABCBF)),
    ((u:QWord($BC7E1A258EA8F71A)),(u:$3FF00BCCEB7707EC)),
    ((u:$3C74362CA5BC26F2),(u:$3FF00C7EE448EE02)),
    ((u:$3C9095A56C919D02),(u:$3FF00D30E4D0C483)),
    ((u:QWord($BC6406AC4E81A646)),(u:$3FF00DE2ED0EE0F5)),
    ((u:$3C9B5A6902767E08),(u:$3FF00E94FD0398E0)),
    ((u:QWord($BC991B2060859320)),(u:$3FF00F4714AF41D3)),
    ((u:$3C8427068AB22306),(u:$3FF00FF93412315C)),
    ((u:$3C9C1D0660524E08),(u:$3FF010AB5B2CBD11)),
    ((u:QWord($BC9E7BDFB3204BE8)),(u:$3FF0115D89FF3A8B)),
    ((u:$3C8843AA8B9CBBC6),(u:$3FF0120FC089FF63)),
    ((u:QWord($BC734104EE7EDAE8)),(u:$3FF012C1FECD613B)),
    ((u:QWord($BC72B6AEB6176892)),(u:$3FF0137444C9B5B5)),
    ...
    ((u:QWord($BC990565902C5F44)),(u:$3FF016F0169949ED)),
    ((u:$3C870FC41C5C2D54),(u:$3FF017A28AF25567)),
    ((u:$3C94B9A6E145D76C),(u:$3FF018550706AB62)),
    ((u:QWord($BC7008EFF5142BFA)),(u:$3FF019078AD6A19F)),
    ((u:QWord($BC977669F033C7DE)),(u:$3FF019BA16628DE2)),
    ((u:QWord($BC909BB78EEEAD0A)),(u:$3FF01A6CA9AAC5F3)),
    ((u:$3C9371231477ECE6),(u:$3FF01B1F44AF9F9E)),
    ((u:$3C75E7626621EB5A),(u:$3FF01BD1E77170B4)),
    ((u:QWord($BC9BC72B100828A4)),(u:$3FF01C8491F08F08)),
    ((u:QWord($BC6CE39CBBAB8BBE)),(u:$3FF01D37442D5070)),
    ((u:$3C816996709DA2E2),(u:$3FF01DE9FE280AC8)),
    ((u:QWord($BC8C11F5239BF536)),(u:$3FF01E9CBFE113EF)),
    ((u:$3C8E1D4EB5EDC6B4),(u:$3FF01F4F8958C1C6)),
    ((u:QWord($BC9AFB99946EE3F0)),(u:$3FF020025A8F6A35)),
    ((u:QWord($BC98F06D8A148A32)),(u:$3FF020B533856324)),
    ((u:QWord($BC82BF310FC54EB6)),(u:$3FF02168143B0281)),
    ((u:QWord($BC9C95A035EB4176)),(u:$3FF0221AFCB09E3E)),
    ((u:QWord($BC9491793E46834C)),(u:$3FF022CDECE68C4F)),
    ((u:QWord($BC73E8D0D9C49090)),(u:$3FF02380E4DD22AD)),
    ((u:QWord($BC9314AA16278AA4)),(u:$3FF02433E494B755)),
    ((u:$3C848DAF888E9650),(u:$3FF024E6EC0DA046)),
    ((u:$3C856DC8046821F4),(u:$3FF02599FB483385)),
    ((u:$3C945B42356B9D46),(u:$3FF0264D1244C719)),
    ((u:QWord($BC7082EF51B61D7E)),(u:$3FF027003103B10E)),
    ((u:$3C72106ED0920A34),(u:$3FF027B357854772)),
    ((u:QWord($BC9FD4CF26EA5D0E)),(u:$3FF0286685C9E059)),
    ((u:QWord($BC909F8775E78084)),(u:$3FF02919BBD1D1D8)),
  ...
  cTanhDb: array[0..11, 0..2] of Tb64u64 = (
    ...
    ((u:$3FD00764A988BF73),(u:$3FCF676484C0703B),(u:QWord($B970000000000000))),
    ((u:$3FD17D1E8A63711F),(u:$3FD110E96A6C2D96),(u:QWord($B970000000000000))),
    ((u:$3FD291C601A05276),(u:$3FD210B7D0C03743),(u:$3C70000000000000)),
    ((u:$3FD36F33D51C264D),(u:$3FD2DBB7B1C91363),(u:QWord($B950000000000000))),
    ((u:$3FD43EAEA23649C3),(u:$3FD39877ED028641),(u:QWord($BC90000000000000))),
    ((u:$3FDD88D7550B2826),(u:$3FDB9A3637366AFD),(u:$3C70000000000000)),
    ((u:$3FDE611AA58AB608),(u:$3FDC493DC899E4A6),(u:QWord($BC90000000000000))),
    ((u:$3FE01EFE7AC8C15D),(u:$3FDDC3FE1B524821),(u:QWord($B970000000000000))),
    ((u:$3FE1005EC0BCCABB),(u:$3FDF20B1C8557DED),(u:QWord($BC90000000000000))),
  ...
  cTanhL2hM:   Tb64u64 = (u:QWord($BF162E42FF000000));   // -0x1.62e42ffp-14
  cTanhL2lM:   Tb64u64 = (u:QWord($BCF718432A1B0E26));   // -0x1.718432a1b0e26p-48
  cTanhL2L:    Tb64u64 = (u:QWord($BF162E42FEFA39EF));   // -0x1.62e42fefa39efp-14 (large path)
  ...
  cTanhMask27: UInt64  = QWord($FFFFFFFFF8000000);
...
const
  ...
  cSinpiRefCll0: Tb64u64 = (u:QWord($BB755D3C7E3CBFF9)); // -0x1.55d3c7e3cbff9p-72
  ...
  cSincosN1_Sn: array[0..32, 0..1] of Tb64u64 = (
    ...
    ((u:$3FA91F6600000000),(u:QWord($BE1DE44FD832257A))),
    ((u:$3FB917A6C0000000),(u:QWord($BE0EB25EA0F138C7))),
    ((u:$3FC2C81060000000),(u:$3E3D1CC27444C003)),
    ((u:$3FC8F8B840000000),(u:QWord($BE1CB2CFAA4DA337))),
    ((u:$3FCF19F980000000),(u:QWord($BE237A839542DEEF))),
    ((u:$3FD2940630000000),(u:QWord($BE12A60FA574A369))),
    ((u:$3FD58F9A70000000),(u:$3E36AC7F73F84090)),
    ((u:$3FD87DE2A0000000),(u:$3E3ABAA58B469891)),
    ((u:$3FDB5D1010000000),(u:QWord($BE387A8CFF5264EA))),
    ((u:$3FDE2B5D40000000),(u:QWord($BE3FE4271387C9DC))),
    ((u:$3FE0738798000000),(u:$3E222FFED9697FAF)),
    ((u:$3FE1C73B38000000),(u:$3E2AE68C86C9774A)),
    ((u:$3FE30FF800000000),(u:QWord($BE38F47E58F7E631))),
    ((u:$3FE44CF328000000),(u:QWord($BE37B7114F3FC4AF))),
    ((u:$3FE57D6938000000),(u:QWord($BE3B989B02EAE413))),
    ((u:$3FE6A09E68000000),(u:QWord($BE280C4336F74D05))),
    ((u:$3FE7B5DF20000000),(u:$3E33557D76F0AC85)),
    ((u:$3FE8BC8068000000),(u:$3E38A8BA05A743DA)),
    ((u:$3FE9B3E048000000),(u:QWord($BDD8F17E98771434))),
    ((u:$3FEA9B6628000000),(u:$3E20EA1A3033EC62)),
    ((u:$3FEB728348000000),(u:QWord($BE37348E1378D3E6))),
    ((u:$3FEC38B2F0000000),(u:$3E280BDB0D23E9D1)),
    ((u:$3FECED7AF8000000),(u:QWord($BE3E19C46879EDAF))),
    ((u:$3FED906BD0000000),(u:QWord($BE19AE573AEA067C))),
    ((u:$3FEE212108000000),(u:QWord($BE384BC8DA0298EE))),
    ((u:$3FEE9F4158000000),(u:QWord($BE239D225A27D387))),
    ((u:$3FEF0A7EF8000000),(u:$3E3C9186B952C7AE)),
    ((u:$3FEF6297D0000000),(u:QWord($BDD1469FAA77A357))),
    ((u:$3FEFA75580000000),(u:QWord($BE1EEB5D2BD05465))),
  ...
  cSincosN1_Sm: array[0..32, 0..1] of Tb64u64 = (
    ((u:$0000000000000000),(u:$0000000000000000)),
    ((u:$3F59220000000000),(u:QWord($BE354466E349EE53))),
    ...
    ((u:$3F82D96C00000000),(u:QWord($BE3E35ED1FA23D22))),
    ((u:$3F85FDA000000000),(u:$3E1BD602F04014C8)),
    ((u:$3F8921D200000000),(u:QWord($BDD909C3DCCF0E28))),
    ((u:$3F8C460000000000),(u:QWord($BE0E1B7526EBF9F2))),
    ((u:$3F8F6A2A00000000),(u:QWord($BE32A8CD06AF94A2))),
    ((u:$3F91472700000000),(u:$3E0B5AE26618769E)),
    ((u:$3F92D93700000000),(u:QWord($BE31073C40B25037))),
    ((u:$3F946B4400000000),(u:QWord($BE3F80C5F9200607))),
    ((u:$3F95FD4D00000000),(u:$3E20FD5912EF3F57)),
    ((u:$3F978F5300000000),(u:$3E377727C10D8CA5)),
    ((u:$3F99215600000000),(u:QWord($BE00B933040D8EB2))),
    ((u:$3F9AB35500000000),(u:QWord($BE33ABEC0D92AE48))),
    ((u:$3F9C454F00000000),(u:$3E33394EC7229C28)),
    ((u:$3F9DD74600000000),(u:QWord($BE3CE6D5319D653E))),
    ((u:$3F9F693700000000),(u:$3E28E8E7807F600B)),
    ((u:$3FA07D9200000000),(u:QWord($BDC9EEA00D71246D))),
    ((u:$3FA1468600000000),(u:QWord($BE325E9F40A5121A))),
    ((u:$3FA20F7700000000),(u:$3E19D6238D09F231)),
    ((u:$3FA2D86580000000),(u:QWord($BE14D75465D2F213))),
    ((u:$3FA3A15100000000),(u:QWord($BE137BCA0781D73A))),
    ((u:$3FA46A3980000000),(u:QWord($BE20079E86EEC954))),
    ((u:$3FA5331F00000000),(u:QWord($BE3E222F8A75DE87))),
    ((u:$3FA5FC0100000000),(u:QWord($BE36B7995E4BB32D))),
    ((u:$3FA6C4DF80000000),(u:QWord($BDF41523E139C56B))),
  ...
  cSincosN1_Cm: array[0..32, 0..1] of Tb64u64 = (
    ...
    ((u:$3FEFFFD888000000),(u:QWord($BE338BAB6D94C71D))),
    ((u:$3FEFFFC250000000),(u:$3E16BB5DD7625BCD)),
    ((u:$3FEFFFA730000000),(u:QWord($BE3B439D8A459600))),
    ((u:$3FEFFF8718000000),(u:$3E237CE2EEC7251B)),
    ((u:$3FEFFF6218000000),(u:QWord($BE2646D24A88970E))),
    ((u:$3FEFFF3828000000),(u:QWord($BE39BB848BDB041E))),
    ((u:$3FEFFF0940000000),(u:$3E3E29DE85718CC2)),
    ((u:$3FEFFED570000000),(u:$3E3CC695B5E89E49)),
    ((u:$3FEFFE9CB8000000),(u:QWord($BE3DA572F6A4BCCA))),
    ((u:$3FEFFE5F08000000),(u:QWord($BE30D43929B71F74))),
    ((u:$3FEFFE1C68000000),(u:$3E0C32DDD89AA147)),
    ((u:$3FEFFDD4D8000000),(u:$3E3FBC7A9242CCF3)),
    ((u:$3FEFFD8860000000),(u:$3E1099A19765595D)),
    ((u:$3FEFFD36F8000000),(u:QWord($BE2DBAFF3C93CDC4))),
    ((u:$3FEFFCE0A0000000),(u:QWord($BE38EACC3AF7AC55))),
    ((u:$3FEFFC8558000000),(u:QWord($BE3996F62D2DF41D))),
    ((u:$3FEFFC2520000000),(u:QWord($BE3071603E8582DF))),
    ((u:$3FEFFBBFF8000000),(u:$3E07E5454B8225E9)),
    ((u:$3FEFFB55E8000000),(u:QWord($BE3ED0128D24B027))),
    ((u:$3FEFFAE6E0000000),(u:$3E25569984BD1A7A)),
    ((u:$3FEFFA72F0000000),(u:QWord($BDA08A362D33736D))),
    ((u:$3FEFF9FA10000000),(u:$3DFA441BA9901FD5)),
    ((u:$3FEFF97C40000000),(u:$3E304600A0A95596)),
    ((u:$3FEFF8F988000000),(u:QWord($BE3387D3A589FA3D))),
    ((u:$3FEFF871D8000000),(u:$3E36DC0EF98B1C67)),
    ((u:$3FEFF7E540000000),(u:$3E301907C4C59658)),
    ((u:$3FEFF753B8000000),(u:$3E38DC8B1E83CCFF)),
    ((u:$3FEFF6BD48000000),(u:QWord($BE2C4BBB2C348040))),
    ((u:$0000000000000000),(u:$0000000000000000)));

  // sincosn2 tables (accurate-path)
  cSincosN2_Sn: array[0..32, 0..1] of Tb64u64 = (
    ((u:$0000000000000000),(u:$0000000000000000)),
    ((u:$3FA91F65F10DD814),(u:QWord($BC2912BD0D569A90))),
    ((u:$3FB917A6BC29B42C),(u:QWord($BC3E2718D26ED688))),
    ((u:$3FC2C8106E8E613A),(u:$3C513000A89A11E0)),
    ((u:$3FC8F8B83C69A60B),(u:QWord($BC626D19B9FF8D82))),
    ((u:$3FCF19F97B215F1B),(u:QWord($BC642DEEF11DA2C4))),
    ((u:$3FD294062ED59F06),(u:QWord($BC75D28DA2C4612D))),
    ((u:$3FD58F9A75AB1FDD),(u:QWord($BC1EFDC0D58CF620))),
    ((u:$3FD87DE2A6AEA963),(u:QWord($BC672CEDD3D5A610))),
    ((u:$3FDB5D1009E15CC0),(u:$3C65B362CB974183)),
    ((u:$3FDE2B5D3806F63B),(u:$3C5E0D891D3C6841)),
    ((u:$3FE073879922FFEE),(u:QWord($BC8A5A014347406C))),
    ((u:$3FE1C73B39AE68C8),(u:$3C8B25DD267F6600)),
    ((u:$3FE30FF7FCE17035),(u:QWord($BC6EFCC626F74A6F))),
    ((u:$3FE44CF325091DD6),(u:$3C68076A2CFDC6B3)),
    ((u:$3FE57D69348CECA0),(u:QWord($BC875720992BFBB2))),
    ((u:$3FE6A09E667F3BCD),(u:QWord($BC8BDD3413B26456))),
    ((u:$3FE7B5DF226AAFAF),(u:QWord($BC70F537ACDF0AD7))),
    ((u:$3FE8BC806B151741),(u:QWord($BC82C5E12ED1336D))),
    ((u:$3FE9B3E047F38741),(u:QWord($BC830EE286712474))),
    ((u:$3FEA9B66290EA1A3),(u:$3C39F630E8B6DAC8)),
    ((u:$3FEB728345196E3E),(u:QWord($BC8BC69F324E6D61))),
    ((u:$3FEC38B2F180BDB1),(u:QWord($BC76E0B1757C8D07))),
    ((u:$3FECED7AF43CC773),(u:QWord($BC5E7B6BB5AB58AE))),
    ((u:$3FED906BCF328D46),(u:$3C7457E610231AC2)),
    ((u:$3FEE212104F686E5),(u:QWord($BC8014C76C126527))),
    ((u:$3FEE9F4156C62DDA),(u:$3C8760B1E2E3F81E)),
    ((u:$3FEF0A7EFB9230D7),(u:$3C752C7ADC6B4989)),
    ((u:$3FEF6297CFF75CB0),(u:$3C7562172A361FD3)),
    ((u:$3FEFA7557F08A517),(u:QWord($BC87A0A8CA13571F))),
    ((u:$3FEFD88DA3D12526),(u:QWord($BC887DF6378811C7))),
    ((u:$3FEFF621E3796D7E),(u:QWord($BC6C57BC2E24AA15))),
    ((u:$3FF0000000000000),(u:$0000000000000000)));
  cSincosN2_Sm: array[0..31, 0..1] of Tb64u64 = (
    ((u:$0000000000000000),(u:$0000000000000000)),
    ((u:$3F5921FAAEE6472E),(u:QWord($BBFEE52E284A9DF8))),
    ((u:$3F6921F8BECCA4BA),(u:$3C02BA407BCAB5B2)),
    ((u:$3F72D97822F996BC),(u:$3C13E5A15ED6AA3E)),
    ((u:$3F7921F0FE670071),(u:$3BFAB967FE6B7A9B)),
    ((u:$3F7F6A65F9A2A3C6),(u:QWord($BC1DE8C48783F3AE))),
    ((u:$3F82D96B0E509703),(u:QWord($BC01E9131FF52DC9))),
    ((u:$3F85FDA037AC05E1),(u:QWord($BC2FF59BF4B574EE))),
    ((u:$3F8921D1FCDEC784),(u:$3C29878EBE836D9D)),
    ((u:$3F8C45FFE1E48AD9),(u:$3C04060E4BD32E79)),
    ((u:$3F8F6A296AB997CB),(u:QWord($BC2F2943D8FE7033))),
    ((u:$3F9147270DAD7133),(u:$3C08769E00E01800)),
    ((u:$3F92D936BBE30EFD),(u:$3C2B5F91EE371D64)),
    ((u:$3F946B4381FCE81B),(u:$3C3FF9F89FB65BE3)),
    ((u:$3F95FD4D21FAB226),(u:QWord($BC20C0A91C37851C))),
    ((u:$3F978F535DDC9F04),(u:$3C2B194AD9B1AA97)),
    ((u:$3F992155F7A3667E),(u:QWord($BBFB1D63091A0130))),
    ((u:$3F9AB354B1504FCA),(u:QWord($BC32AE47937CBDD3))),
    ((u:$3F9C454F4CE53B1D),(u:QWord($BC3D63D7FEF0E36C))),
    ((u:$3F9DD7458C64AB3A),(u:QWord($BC3D653DF3FCC281))),
    ((u:$3F9F693731D1CF01),(u:QWord($BBD3FE9BC66286C7))),
    ((u:$3FA07D91FF984580),(u:QWord($BC3AE248DA7A9007))),
    ((u:$3FA14685DB42C17F),(u:QWord($BC42890D277CB974))),
    ((u:$3FA20F770CEB11C7),(u:QWord($BC4EC1B9D46693B1))),
    ...
    ((u:$3FA6C4DF7D7D5B84),(u:QWord($BC339C56A9BD0A9B))),
    ((u:$3FA78DBAA5874686),(u:QWord($BC34A0EF4035C29C))),
    ((u:$3FA856922BB513C1),(u:$3C491ADFD607CB2B)));
  cSincosN2_Cm: array[0..31, 0..1] of Tb64u64 = (
    ((u:$0000000000000000),(u:$0000000000000000)),
    ((u:$3EB3BD3C88CDCA13),(u:$3B5874628D2B6835)),
    ((u:$3ED3BD3BC5FC5AB4),(u:QWord($BB48A1BEBF665CEF))),
    ((u:$3EE634E1D173443D),(u:$3B6198FF5804D8DC)),
    ((u:$3EF3BD38BAB6D94C),(u:$3B9C73BE2184804E)),
    ((u:$3EFED7A51288A277),(u:QWord($BB9BCD47BF19555B))),
    ((u:$3F0634DA1CEC522D),(u:QWord($BBA3FFF35C1BDB61))),
    ((u:$3F0E39B20C7444E3),(u:$3BAAE49F0BE31E8C)),
    ((u:$3F13BD2C8DA49511),(u:$3BA70DF810BCC0E2)),
    ((u:$3F18FB66EE122F6C),(u:$3B9079FF34BFFA7E)),
    ((u:$3F1ED7875885EA3A),(u:QWord($BBA983278BAA11C2))),
    ((u:$3F22A8C672D4942F),(u:QWord($BBBE4938F661AA14))),
    ...
    ((u:$3F33BCFBD9979A27),(u:QWord($BBD595D548D9A586))),
    ((u:$3F36484EDD7F9E4A),(u:QWord($BBB91DF31AAA6F7F))),
    ((u:$3F38FB18EACC3AF8),(u:QWord($BBD4EAA508EEC2B7))),
    ((u:$3F3BD55996F62D2E),(u:QWord($BBA7C51F7D8F9F71))),
    ((u:$3F3ED71071603E86),(u:QWord($BBDF4827CCB50B62))),
    ((u:$3F41001E81ABAB48),(u:QWord($BBD12F4A2E3616D5))),
    ((u:$3F42A86F68094692),(u:$3BE604E1F8F76C27)),
    ((u:$3F44647AAA599ED1),(u:QWord($BBE1A79A86FB8FF5))),
    ((u:$3F46344004228D8B),(u:$3BE33736C96557C9)),
    ((u:$3F4817BF2DDF22B3),(u:$3BEFC0555A81D729)),
    ((u:$3F4A0EF7DCFFAFAB),(u:$3BE54D46B817BCA4)),
    ((u:$3F4C19E9C3E9D2C5),(u:QWord($BB970A980659E790))),
    ((u:$3F4E389491F8833A),(u:$3BEC7313BEEAB883)),
    ((u:$3F50357BF9BE0ECF),(u:QWord($BBF965827F33D907))),
    ((u:$3F515889C8DD385F),(u:$3BC98094FAB77B42)),
    ((u:$3F52857389776587),(u:QWord($BBFBFDFCE09AEA7B))));
...
const
  ...
  cExpSubnormalU: UInt64 = QWord($C086232BDD7ABCD2); // ix.u > this (signed-bit set) → subnormal branch
...
const
  ...
  cExp2HugeAx:   UInt64 = QWord($8120000000000000); // ax >= this → |x| >= 1024
  cExp2UnderIxU: UInt64 = QWord($C090CC0000000000); // ix.u >= this → underflow
  cExp2SubIxU:   UInt64 = QWord($C08FF00000000000); // ix.u <= this → normal (> subnormal)
  cExp2P54:      Tb64u64 = (u:$3C90000000000000); // 0x1p-54
  cExp2TinyLo:   Tb64u64 = (u:QWord($BC971547652B82FE)); // -0x1.71547652b82fep-54
...
const
  ...
  cExp10SubIxU:   UInt64 = QWord($C0733A7146F72A42); // ix.u < this → normal branch
...
const
  ...
  cExpm1Tz: array[0..64, 0..1] of Tb64u64 = (
    ((u:QWord($BC6797D4686C5393)),(u:QWord($BFCC5041854DF7D4))),
    ((u:QWord($BC8EA1CB9D163339)),(u:QWord($BFCB881A23AEBB48))),
    ((u:$3C8F483A3E8CD60F),(u:QWord($BFCABE60E1F21838))),
    ((u:$3C7DFFD920F493DB),(u:QWord($BFC9F3129931FAB0))),
    ((u:QWord($BC851BFDBB129094)),(u:QWord($BFC9262C1C3430A0))),
    ((u:$3C8CD3E5225E2206),(u:QWord($BFC857AA375DB4E4))),
    ((u:$3C5E3A6BDAECE8F9),(u:QWord($BFC78789B0A5E0C0))),
    ((u:QWord($BC8DAF2AE0C2D3D4)),(u:QWord($BFC6B5C7478983D8))),
    ((u:QWord($BC7FD36226FADD44)),(u:QWord($BFC5E25FB4FDE210))),
    ((u:$3C7D887CD0341AB0),(u:QWord($BFC50D4FAB639758))),
    ((u:QWord($BC8676A52A1A618B)),(u:QWord($BFC43693D679612C))),
    ((u:$3C79776B420AD283),(u:QWord($BFC35E28DB4ECD9C))),
    ((u:$3C73D5FD7D70A5ED),(u:QWord($BFC2840B5836CF68))),
    ((u:$3C5A94AD2C8FA0BF),(u:QWord($BFC1A837E4BA3760))),
    ((u:$3C26AD4C353465B0),(u:QWord($BFC0CAAB118A1278))),
    ((u:QWord($BC78BBA170E59B65)),(u:QWord($BFBFD6C2D0E3D910))),
    ((u:QWord($BC8E1E0A76CB0685)),(u:QWord($BFBE14AED893EEF0))),
    ((u:$3C8FE131F55E75F8),(u:QWord($BFBC4F1331D22D40))),
    ((u:QWord($BC8B5BEEE8BCEE31)),(u:QWord($BFBA85E8C62D9C10))),
    ((u:QWord($BC77FE9B02C25E9B)),(u:QWord($BFB8B92870FA2B58))),
    ((u:QWord($BC832AE7BDAF1116)),(u:QWord($BFB6E8CAFF341FE8))),
    ((u:$3C7A6CFE58CBD73B),(u:QWord($BFB514C92F634788))),
    ((u:$3C68798DE3138A56),(u:QWord($BFB33D1BB17DF2E8))),
    ((u:QWord($BC3589321A7EF10B)),(u:QWord($BFB161BB26CBB590))),
    ((u:QWord($BC78D0E700FCFB65)),(u:QWord($BFAF0540438FD5C0))),
    ((u:$3C8473EF07D5DD3B),(u:QWord($BFAB3F864C080000))),
    ((u:QWord($BC838E62149C16E2)),(u:QWord($BFA7723950130400))),
    ((u:QWord($BC508BB6309BD394)),(u:QWord($BFA39D4A1A77E050))),
    ((u:QWord($BC8BAD3FD501A227)),(u:QWord($BF9F8152AEE94500))),
    ((u:$3C63D27AC39ED253),(u:QWord($BF97B88F290230E0))),
    ((u:QWord($BC8B60BBD08AAC55)),(u:QWord($BF8FC055004416C0))),
    ((u:QWord($BC4A00D03B3359DE)),(u:QWord($BF7FE0154AAEED80))),
    ((u:$0000000000000000),(u:$0000000000000000)),
    ...
    ((u:QWord($BC8EB6980CE14DA7)),(u:$3FA89246D053D180)),
    ((u:$3C77324137D6C342),(u:$3FACC79F4F5613A0)),
    ((u:QWord($BC45272FF30EED1B)),(u:$3FB082B577D34ED8)),
    ((u:QWord($BC81280F19DACE1C)),(u:$3FB2A5DD543CCC50)),
    ((u:QWord($BC8D550AF31C8EC3)),(u:$3FB4CD4FC989CD68)),
    ((u:$3C87923B72AA582D),(u:$3FB6F91575870690)),
    ((u:QWord($BC776C2E732457F1)),(u:$3FB92937074E0CD8)),
    ((u:$3C881F5C92A5200F),(u:$3FBB5DBD3F681220)),
    ((u:$3C8E8AC7A4D3206C),(u:$3FBD96B0EFF0E790)),
    ((u:QWord($BC712DB6F4BBE33B)),(u:$3FBFD41AFCBA45E8)),
    ((u:QWord($BC58C4A5DF1EC7E5)),(u:$3FC10B022DB7AE68)),
    ((u:QWord($BC6BD4B1C37EA8A2)),(u:$3FC22E3B09DC54D8)),
    ((u:$3C85AEB9860044D0),(u:$3FC353BC9FB00B20)),
    ((u:QWord($BC64C26602C63FDA)),(u:$3FC47B8B853AAFEC)),
    ((u:QWord($BC87F644C1F9D314)),(u:$3FC5A5AC59B963CC)),
    ((u:$3C8F5AA8EC61FC2D),(u:$3FC6D223C5B10638)),
    ((u:$3C27AB912C69FFEB),(u:$3FC800F67B00D7B8)),
    ((u:QWord($BC5B3564BC0EC9CD)),(u:$3FC9322934F54148)),
    ((u:$3C86A7062465BE33),(u:$3FCA65C0B85AC1A8)),
    ((u:QWord($BC885718D2FF1BF4)),(u:$3FCB9BC1D3910094)),
    ((u:QWord($BC8045CB0C685E08)),(u:$3FCCD4315E9E0834)),
    ((u:QWord($BC16E7FB859D5055)),(u:$3FCE0F143B41A554)),
    ((u:$3C851BBDEE020603),(u:$3FCF4C6F5508EE5C)),
    ((u:$3C6E17611AFC42C5),(u:$3FD04623D0B0F8C8)),
    ((u:QWord($BC71C5B2E8735A43)),(u:$3FD0E7510FD7C564)),
    ((u:QWord($BC825FE139C4CFFD)),(u:$3FD189C1ECAEB084)),
  ...
  cExpm1UnderIxA: UInt64 = QWord($C0425E4F7B2737FA); // ix.u >= → soft underflow approx
  cExpm1UnderIxB: UInt64 = QWord($C042B708872320E2); // ix.u >= → return -1 + 2^-55
  ...
  cExpm1UD: Tb64u64 = (u:QWord($BFEFFFFFFFFFFFFF)); // -0x1.fffffffffffffp-1
